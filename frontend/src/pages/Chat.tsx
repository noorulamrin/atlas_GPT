  ...
  const handleDeleteChats = async () => {
    try {
      if (chatMessages && chatMessages.length == 0) {
        toast.error("No chats to clear", { id: "deletechats" });
      } else {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Feel free to ask me questions about my areas of knowledge, including
            business, advice, education, etc. Just remember to avoid sharing
